...
/**
 * This class represents WSDL command line tool related constants.
 */
public class Constants {

    // WSDL command line tool messages
    public static final String MESSAGE_FOR_MISSING_INPUT_ARGUMENT = "The input file path argument is missing. " +
            "Please provide the URL or file path of the WSDL with -i or --input flag. " +
            "\ne.g: bal wsdl --input <URL or file path of WSDL file>";
