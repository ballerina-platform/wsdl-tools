...
package io.ballerina.wsdl.core.generator.xsdtorecord.util;
...
import static io.ballerina.wsdl.core.generator.Constants.BAL_KEYWORDS;
import static io.ballerina.wsdl.core.generator.Constants.ESCAPE_PATTERN;
import static io.ballerina.wsdl.core.generator.Constants.REGEX_ONLY_NUMBERS_OR_NUMBERS_WITH_SPECIAL_CHARACTERS;
import static io.ballerina.wsdl.core.generator.Constants.REGEX_WITHOUT_SPECIAL_CHARACTERS;
import static io.ballerina.wsdl.core.generator.Constants.REGEX_WORDS_STARTING_WITH_NUMBERS;

/**
 * Utility class providing helper methods for converting XML Schema Definition (XSD) into Ballerina record.
 *
 * @since 0.1.0
 */
public class XsdToRecordUtils {
    ...
    public static String incrementFieldName(String fieldName) {
        return fieldName + "1";
    }
}
